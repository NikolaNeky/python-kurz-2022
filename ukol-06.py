...
class Auto:
    ...
    def get_info(self):
        return f"Informace o autě: {self.registracni_znacka}, {self.typ_vozidla}"
...
Dotaz_uzivatele = input("Zadej značku: ")

if Dotaz_uzivatele == "Peugeot" or Dotaz_uzivatele == "Škoda":
    if Dotaz_uzivatele == "Škoda":
        print(Auto2.get_info())
        print(Auto2.pujc_auto())
    elif Dotaz_uzivatele == "Peugeot":
        print(Auto1.get_info())
        print(Auto1.pujc_auto())
else:
    print("Tuto značku neevidujeme.")